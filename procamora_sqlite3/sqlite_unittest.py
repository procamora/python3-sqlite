...
class MyTestCase(unittest.TestCase):
    def setUp(self) -> NoReturn:
        self.dump: Path = Path('unittest.sql')
        self.db: Path = Path('unittest.db')
